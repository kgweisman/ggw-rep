...
var previewSlide = {
	showPreview: function() {
		if (turk.previewMode === true) {
			...
			$('.slide #preview-text').text("You have already completed or returned this HIT, or something very similar. Thanks for participating, and hope to see you next time!");
			$('.slide button').hide();
			showSlide("preview");
		} else {
